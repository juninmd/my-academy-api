...
export class User {
  @ApiProperty({ example: 'user-uuid', description: 'The unique identifier of the user' })
  id: string;
  ...
  @ApiProperty({ example: '123456789', description: 'Telegram ID', required: false })
  telegramId?: string;
  ...
  @ApiProperty({ required: false, type: () => Object, isArray: true, description: 'Personal trainer relations' })
  personals?: Personals[];

  @ApiProperty({ required: false, type: () => Object, isArray: true, description: 'Student relations' })
  students?: Personals[];

  @ApiProperty({ required: false, type: () => [WorkoutsGroup], isArray: true, description: 'Workout groups' })
